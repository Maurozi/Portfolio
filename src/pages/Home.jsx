    ...
    <section className="home" >
      ...
      <Motion.div className="home-projects" ref={projectsRef} variants={fadeUp} initial="hidden" whileInView="show" viewport={{ once: true, amount: 0.3 }}>
        <div className="project-list">
          <Motion.img src="../src/assets/Chatbot-banner.png" alt="Project Image" variants={childFadeUp} />
          <Motion.img src="../src/assets/Chatbot-chat.png" alt="Project Image" variants={childFadeUp} />
          <Motion.img src="../src/assets/YV-phone2.png" alt="Project Image" variants={childFadeUp} />
          <Motion.img src="../src/assets/CE-banner.png" alt="Project Image" variants={childFadeUp} />
          <Motion.img src="../src/assets/CE-phone1.png" alt="Project Image" variants={childFadeUp} />
          <Motion.img src="../src/assets/YV-phone1.png" alt="Project Image" variants={childFadeUp} />
        </div>
      </Motion.div>
      ...
      <Motion.div className="about-me" ref={aboutRef} variants={fadeUp} initial="hidden" whileInView="show" viewport={{ once: true, amount: 0.3 }}>
        ...
        <img src="../src/assets/Diploma.png" alt="Diploma" />
      </Motion.div>
