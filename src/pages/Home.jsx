    ...
    <section className="home" >
      ...
      <Motion.div className="home-projects" ref={projectsRef} variants={fadeUp} initial="hidden" whileInView="show" viewport={{ once: true, amount: 0.3 }}>
        <div className="project-list">
          ...
          <Link className="project-link" to="/projects/code-exchange" aria-label="Open Code Exchange project page">
            <Motion.img className="project-image portrait project-codeexchange-phone" src={cePhone1} alt="Code Exchange project" variants={childFadeUp} whileHover={projectHover} transition={projectHoverTransition} />
          </Link>
          <Link className="project-link" to="/projects/code-exchange" aria-label="Open Code Exchange project page">
            <Motion.img className="project-image landscape project-codeexchange-banner" src={ceBanner} alt="Code Exchange project" variants={childFadeUp} whileHover={projectHover} transition={projectHoverTransition} />
          </Link>
        </div>
      </Motion.div>
